/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-funky&languages=markup+css+clike+javascript+bash+c+csharp+cpp+git+glsl+hlsl&plugins=line-numbers+custom-class */
